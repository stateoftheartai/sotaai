...
DATASETS = {
    ...
    'Other': [
        ...
        'jimregan/clarinpl_sejmsenat', 'jimregan/clarinpl_studio', 'kelm',
        'large_spanish_corpus', 'librispeech_asr', 'lj_speech', 'medal',
        'mnist', 'msr_genomics_kbcomp', 'ollie', 'openslr', 're_dial', 's2orc',
        'sent_comp', 'spanish_billion_words', 'timit_asr', 'tuple_ie',
