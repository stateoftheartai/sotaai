...
def load_dataset(dataset_name):
    ...
    if dataset_name in ["MNIST_SAMPLE", "MNIST_TINY",
                        "MNIST_VAR_SIZE_TINY", "CIFAR",
                        "CIFAR_100", "DOGS"]:
    ...
    if dataset_name in ['IMAGENETTE', 'IMAGENETTE_160', 'IMAGENETTE_320',
