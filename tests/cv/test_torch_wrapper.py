...
class TestTorchWrapper(unittest.TestCase):
    ...
    no_check_ds = ["LSUN", "ImageNet", "CocoDetection", "CocoCaptions",
                   "Flickr30k", "Flickr8k", "HMDB51", "Kinetics400", "UCF101",
    ...
    def test_load_dataset_return_type(self):
        ...
        all_keywords = []
        for task in torch_wrapper.DATASETS.keys():
    ...
    def test_dataset_split_keywords(self):
        ...
        # TODO(tonioteran) Activate.
        # self.assertTrue('train' in torch_wrapper.SPLIT_KEYWORDS)
        # self.assertTrue('test' in torch_wrapper.SPLIT_KEYWORDS)
        # self.assertTrue('validation' in torch_wrapper.SPLIT_KEYWORDS)
        self.assertTrue(True)  # TEMP
